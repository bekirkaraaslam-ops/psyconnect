            ...
            <div className="bg-white rounded-2xl p-5 md:p-8" style={{ border: '1px solid #c8e6dc', boxShadow: '0 1px 6px rgba(74,124,111,0.08)' }}>
              ...
              <ul className="space-y-3 mb-5">
                {[
                  ...
                  'AI SOAP notu (20/ay)',
                  'AI anamnez özeti (10/ay)',
                  'AI seans ilerleme analizi (10/ay)',
                  'AI psikometrik ölçek yorumu (15/ay)',
            ...
            <div className="pricing-pro rounded-2xl p-5 md:p-8 relative" style={{ background: '#4a7c6f', border: '2px solid #3a6b5e' }}>
              ...
              <ul className="space-y-3 mb-8">
                {[
                  ...
                  'Sınırsız AI SOAP notu',
                  'Sınırsız AI anamnez özeti',
                  'Sınırsız AI seans ilerleme analizi',
                  'Sınırsız AI psikometrik ölçek yorumu',
                  'Tüm seans geçmişi',
