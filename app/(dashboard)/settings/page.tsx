...
export default async function SettingsPage() {
  ...
  const { data: psychologist } = await supabase
    .from('psychologists')
    .select('id, full_name, phone_number, subscription_status, subscription_ends_at, klinik_adresi, harita_linki, online_gorusme_linki, hosgeldiniz_mesaji, work_start_hour, work_end_hour')
