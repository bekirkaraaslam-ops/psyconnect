  ...
  return (
    <div className="bg-white rounded-2xl border overflow-hidden" style={{ borderColor: '#dde5e2' }}>
      <div className="px-5 py-3 border-b flex items-center gap-2" style={{ borderColor: '#dde5e2', background: '#f8fafc' }}>
        ...
        <span className="text-sm font-semibold" style={{ color: '#334155' }}>Anamnez Formu</span>
        {isFilled && (
        ...
        {(isPending || isExpired) && (
          <span className="ml-auto text-xs px-2 py-0.5 rounded-full font-medium bg-slate-100 text-slate-500">
