...
const FEATURES = [
  ...
  },
  {
    ...
    tagline: 'Sen uyurken takvim dolar. 7/24 otomatik randevu.',
    old: 'Mesai dışı randevu taleplerini kaçırmak, sabah inbox dolup taşmak.',
    benefits: [
      'Danışan istediği saatte WhatsApp\'tan randevu alır',
      'AI müsait saatlerinizi bilir, uygun teklif sunar',
      'Onaylanan randevu anında takvime düşer',
      'Siz hiçbir şey yapmadan randevu dolmuş olur',
    ],
  },
  {
    id: 'anamnez',
